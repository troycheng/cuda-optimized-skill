...
|---|---|---|
| Automated tests | 746 total; 741 passed, five RTX 5090 opt-in tests skipped outside a GPU environment, zero failed | State recovery, evidence binding, shared-host guard, timeouts, restoration, and input validation |
